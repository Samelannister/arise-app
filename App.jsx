      ...
      <div style={{flex:1,overflowY:"auto",position:"relative",zIndex:10,display:isTablet?"flex":"block"}}>
        ...
        {tab==="profile"&&(
          <div style={{padding:"14px 12px 80px"}}>
            ...
            {!showReset ? (
              <button onClick={()=>setShowReset(true)} style={{width:"100%",marginTop:7,padding:"11px",background:"rgba(239,68,68,0.08)",border:"1px solid rgba(239,68,68,0.25)",borderRadius:10,cursor:"pointer",fontSize:9,fontFamily:"'Orbitron',monospace",fontWeight:700,color:"#EF4444",letterSpacing:"0.08em"}}>
